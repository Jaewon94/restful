            ...
            <div class="card-body">
                ...
                <form>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter product_name" id="product_name">
                    </div>
                    <div class="form-group">
                        <label for="inventory">재고량:</label>
                        <input type="text" class="form-control" placeholder="Enter inventory" id="inventory">
                    </div>
                    <div class="form-group">
